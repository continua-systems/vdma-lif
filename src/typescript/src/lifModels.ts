// To parse this data:
//
//   import { Convert, LIFSchema } from "./file";
//
//   const lIFSchema = Convert.toLIFSchema(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface LIFSchema {
  /**
...
export class Convert {
  public static toLIFSchema(json: string): LIFSchema {
    return cast(JSON.parse(json), r("LIFSchema"));
  }

  public static lIFSchemaToJson(value: LIFSchema): string {
    return JSON.stringify(uncast(value, r("LIFSchema")), null, 2);
  }
}
